...
const NavBar = () => {
  ...
  return (
    <>
      ...
      >
        {/* Left panel */}
        <div className="w-[260px] min-w-[260px] flex flex-col border-r border-gray-200 flex-shrink-0">
      ...
      <div className='bg-gray-900 text-white'>
        <Container>
          <div className='flex justify-between items-center'>
            <ul className='flex items-center gap-x-6 text-sm font-pop font-medium'>

              {/* ✅ Hamburger — আলাদা li, শুধু sidebar open */}
              <li>
                <button
              ...
              {/* ✅ All Categories — আলাদা li, শুধু hover dropdown */}
              <li className='flex items-stretch relative group' style={{ marginLeft: '-24px' }}>
                ...
                {/* Dropdown */}
                <div className='absolute top-full left-0 w-[210px] bg-white text-gray-800 shadow-2xl z-30
              ...
              <li className='relative group'>
                <Link to="#" className='flex items-center gap-x-1 text-[#808080] hover:text-white duration-300 py-6'>
                  Home
                  <FaAngleDown size={18} className='transition-transform duration-300 group-hover:rotate-180' />
                </Link>
                <div className='absolute top-full left-0 w-[180px] bg-white shadow-2xl rounded-md
                  opacity-0 invisible translate-y-3
                  group-hover:opacity-100 group-hover:visible group-hover:translate-y-0
                  transition-all duration-300 z-50'>
                  <Link to="#" className='block px-5 py-3 text-sm text-gray-700 hover:bg-primary hover:text-white duration-300'>Home One</Link>
                  <Link to="#" className='block px-5 py-3 text-sm text-gray-700 hover:bg-primary hover:text-white duration-300'>Home Two</Link>
                  <Link to="#" className='block px-5 py-3 text-sm text-gray-700 hover:bg-primary hover:text-white duration-300'>Home Three</Link>
                </div>
              </li>
